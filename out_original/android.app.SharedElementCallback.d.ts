...
declare module android {
	export module app {
		export class SharedElementCallback {
			...
			public onSharedElementsArrived(param0: java.util.List, param1: java.util.List, param2: android.app.SharedElementCallback.OnSharedElementsReadyListener): void;
		}
