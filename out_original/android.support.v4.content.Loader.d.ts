		...
		export module v4 {
			export module content {
				export class Loader {
					...
					public getId(): number;
					public registerListener(param0: number, param1: android.support.v4.content.Loader.OnLoadCompleteListener): void;
					public unregisterListener(param0: android.support.v4.content.Loader.OnLoadCompleteListener): void;
					public registerOnLoadCanceledListener(param0: android.support.v4.content.Loader.OnLoadCanceledListener): void;
					public unregisterOnLoadCanceledListener(param0: android.support.v4.content.Loader.OnLoadCanceledListener): void;
				...
				export module Loader {
					export class ForceLoadContentObserver {
						...
						public constructor();
						public constructor(param0: android.support.v4.content.Loader);
